...
const PrivacyPolicy = () => {
	return (
		<Page>
			<PageInnerLayout>
				<h2 style={{ marginBottom: 32 }}>Privacy Policy</h2>
				...
				<p>
					...
					{`'`}s account, such as Your name, Your email address, Your activities
				...
				<li>
					...
					use local stored objects {`(`}or Flash Cookies{`)`} to collect and
